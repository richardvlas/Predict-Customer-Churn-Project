...
def test_import(import_data):
    ...
    try:
        ...
        logging.error(
            "Testing import_data function: The file doesn't appear to have rows or columns")
        raise err
...
def test_eda(perform_eda, df):
    ...
    try:
        ...
        logging.error(
            "Testing perform_eda function: The perform_eda function did not create correct number of images")
        raise err
...
def test_encoder_helper(encoder_helper, df):
    ...
    try:
        ...
        logging.error(
            "Testing encoder_helper function: The dataframe did not contain the transformed features")
        raise err
...
def test_perform_feature_engineering(perform_feature_engineering, df):
    ...
    try:
        ...
        logging.error(
            "Testing perform_feature_engineering function: The train and test data objects appear to not contain data")
        raise err
...
def test_train_models(train_models, X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        logging.error(
            "Testing train_models function: The function did not create correct number of models")
        raise err
    ...
    try:
        ...
        logging.error(
            "Testing train_models function: The function did not create correct number of images")
        raise err
